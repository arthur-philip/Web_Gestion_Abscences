...
Créer une nouvelle base de donnée 'gestion_eleve' avec l'interclassement 'utf8_general_ci', puis cliquer sur 'Importer'. Choisir le fichier 'gestion_eleve.sql' dans le dossier 'C:\wamp64\www\Projet_Web\doc' puis cliquer sur 'Exécuter'.
...
Utiliser un navigateur pour vous rendre à l'adresse suivante : 'http://localhost/Projet_Web/'.