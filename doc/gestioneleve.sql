...
--
-- Client :  localhost
-- Généré le :  Lun 19 Novembre 2018 à 10:39
...
--
ALTER TABLE `personnel`
  ADD CONSTRAINT `personnel_administrateur_fk` FOREIGN KEY (`numeropersonnel`) REFERENCES `administrateur` (`id_administrateur`),
  ADD CONSTRAINT `personnel_administratif_fk` FOREIGN KEY (`numeropersonnel`) REFERENCES `administratif` (`id_administratif`),
  ADD CONSTRAINT `personnel_professeur_fk` FOREIGN KEY (`numeropersonnel`) REFERENCES `professeur` (`id_professeur`);
